...
%ifndef PRINT_RAX_ROUTINES
%define PRINT_RAX_ROUTINES
...
section .text
    ...
    ; rax contains the binary to print to hex
    ; rdi number of bytes from rax to be printed from right to left
    print_rax_hex:
        ...
        mov rdx, r8                                 ; arg3 = rdx = length of the first message
        syscall
